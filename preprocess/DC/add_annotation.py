...
class Leaf:
    ...
    nmod_dist: float = 0
    nmod_dist_disc: float = 0
    punct_dist: float = 0
    punct_dist_disc: float = 0
    case_dist: float = 0
    case_dist_disc: float = 0
    det_dist: float = 0
    det_dist_disc: float = 0
    nsubj_dist: float = 0
    nsubj_dist_disc: float = 0
    amod_dist: float = 0
    amod_dist_disc: float = 0
    mark_dist: float = 0
    mark_dist_disc: float = 0
    advmod_dist: float = 0
    advmod_dist_disc: float = 0
    root_dist: float = 0
    root_dist_disc: float = 0
    dobj_dist: float = 0
    dobj_dist_disc: float = 0
    conj_dist: float = 0
    conj_dist_disc: float = 0
    aux_dist: float = 0
    aux_dist_disc: float = 0
    cc_dist: float = 0
    cc_dist_disc: float = 0
    compound_dist: float = 0
    compound_dist_disc: float = 0
    acl_dist: float = 0
    acl_dist_disc: float = 0
    cop_dist: float = 0
    cop_dist_disc: float = 0
    advcl_dist: float = 0
    advcl_dist_disc: float = 0
    ccomp_dist: float = 0
    ccomp_dist_disc: float = 0
    xcomp_dist: float = 0
    xcomp_dist_disc: float = 0
    name_dist: float = 0
    name_dist_disc: float = 0
    neg_dist: float = 0
    neg_dist_disc: float = 0
    auxpass_dist: float = 0
    auxpass_dist_disc: float = 0
    parataxis_dist: float = 0
    parataxis_dist_disc: float = 0
    nummod_dist: float = 0
    nummod_dist_disc: float = 0
    nsubjpass_dist: float = 0
    nsubjpass_dist_disc: float = 0
    appos_dist: float = 0
    appos_dist_disc: float = 0
    expl_dist: float = 0
    expl_dist_disc: float = 0
    mwe_dist: float = 0
    mwe_dist_disc: float = 0
    discourse_dist: float = 0
    discourse_dist_disc: float = 0
    csubj_dist: float = 0
    csubj_dist_disc: float = 0
...
class DataPoint(Token, Leaf):
    ...
    time: int = 0
    logtime: float = 0
    length_prev_1: float = 0
    log_gmean_freq_prev_1: float = 0
    length_prev_2: float = 0
    log_gmean_freq_prev_2: float = 0
...
def merge_token_duration(article2tokens, subj2first_duration, article2leaves):
    ...
    for subj_id, article2duration in subj2first_duration.items():
        for text_id, wnum2duration in sorted(
            ...
            length_prev_2 = 4.86941
            log_gmean_freq_prev_2 = 11.0747
            for i, token in enumerate(tokens):
                ...
                if duration:
                    data_point = DataPoint(
                        ...
                        **asdict(leaf) if leaf else {},
                        ...
                        length_prev_2=length_prev_2,
                        log_gmean_freq_prev_2=log_gmean_freq_prev_2
                    )
                else:
                    data_point = DataPoint(
                        **asdict(token),
                ...
                length_prev_2 = length_prev_1
                log_gmean_freq_prev_2 = log_gmean_freq_prev_1
